...
//	std::make_pair(0.,_EcmsTag_)};
  ...
  public:
    ...
    /// Constructor
    /// Constructor
    MC13TeV_SPINCORR_emu_TOP_2bs()
      : Analysis("MC13TeV_SPINCORR_emu_TOP_2bs")
    {    }
...
//	    std::cout << "vw_antitop mom. = " << tbar << std::endl;
  ...
  DECLARE_RIVET_PLUGIN(MC13TeV_SPINCORR_emu_TOP_2bs);
