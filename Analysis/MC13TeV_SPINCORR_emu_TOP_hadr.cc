...
namespace Rivet {
  ...
  class MC13TeV_SPINCORR_emu_TOP_hadr : public Analysis {
...
//	std::make_pair(0.,_EcmsTag_)};
  ...
  public:
    ...
    /// Constructor
    /// Constructor
    MC13TeV_SPINCORR_emu_TOP_hadr()
      : Analysis("MC13TeV_SPINCORR_emu_TOP_hadr")
    {    }
...
//	    std::cout << "vw_antitop mom. = " << tbar << std::endl;
  ...
  DECLARE_RIVET_PLUGIN(MC13TeV_SPINCORR_emu_TOP_hadr);
