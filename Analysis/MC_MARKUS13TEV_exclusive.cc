...
namespace Rivet {
  ...
  class MC_MARKUS13TEV_exclusive : public Analysis {
...
#include "NLOHisto1D.cc"
  ...
  public:
    ...
    /// Constructor
    MC_MARKUS13TEV_exclusive()
      : Analysis("MC_MARKUS13TEV_exclusive")
    {    }
  ...
  public:
    ...
    void init() {
       ...
       _h_mt2 = bookNLOHisto1D("mt2", 100, 0., 200.);
...
scale(_h_selected_events, factor);
  ...
  DECLARE_RIVET_PLUGIN(MC_MARKUS13TEV_exclusive);
